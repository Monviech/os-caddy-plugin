...
- After you have received Version 1.5.2 from the OPNsense repository, delete this repository. [How to remove](https://github.com/Monviech/os-caddy-plugin?tab=readme-ov-file#how-to-remove)
...
pkg update
```
Afterwards install os-caddy from the Plugins in the GUI.
The caddy_custom.pkg comes automatically from the OPNsense Repository if your OPNsense Firewall is compatible.
